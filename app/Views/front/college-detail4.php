...
<body>
    ...
    <section class="container-fluid container-xl mt-3">
        <div class="row align-items-center co_p">
            <div class="col-12 col-lg-7">
                <div class="imgs_im">
                    <img src="<?= base_url($college['cover_image'])?>">
                    <div class="sliders_col swiper slide_ss">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                            <div class="slide_cc">
                                <img src="<?= base_url()?>/public/front/imgs/fs-2.png">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="slide_cc">
                                <img src="<?= base_url()?>/public/front/imgs/fs-3.png">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="slide_cc">
                                <img src="<?= base_url()?>/public/front/imgs/fs-4.png">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="slide_cc">
                                <img src="<?= base_url()?>/public/front/imgs/fs-5.png">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="slide_cc">
                                <img src="<?= base_url()?>/public/front/imgs/fs-6.png">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="slide_cc">
                                <img src="<?= base_url()?>/public/front/imgs/fs-i.png">
                            </div>
                        </div>
                        </div>
                        <div class="swiper-button-next ar-b ar-b2"></div>
                        <div class="swiper-button-prev ar-b ar-b2"></div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-5 ps-0 ps-lg-4 mt-5 mt-lg-0">
                 <?= $college['short_description']?>
                 <a href="#" class="know_mmm">Get To Know More</a>
            </div>
    ...
    <section class="container-fluid container-xl">
        <div class="row m_p_s">
            ...
            <div class="mt-4">
                <h1 class="co-tie1">Steps to follow</h1>
            </div>
            <div class="pro_grid mt-4">
