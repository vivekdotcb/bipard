                                        ...
                                        <div class="card-block">
                                            <div class="dt-responsive table-responsive">
                                                ...
                                                <tbody>
                                                    ...
                                                    $allData = \Config\Database::connect()->table('db_training_daily_report')->orderBy('question', 'asc')->where('DATE(created_at)', $date)->where('created_by', $sesid)->get()->getResultArray(); 
