                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <a style="position: absolute; right: 20px; top: 5px;" class="btn btn-primary btn-add-task waves-effect waves-light m-t-10" href="<?= base_url('admin/'.$page_name.'/'.$date.'/'.$_SESSION['user']['id']) ?>" ><?php if ($date == date('Y-m-d')){ echo 'Add&Edit'; } else { echo "View";}?></a>
                                        </div>
                                        ...
                                        <div class="card-block">
                                            <div class="dt-responsive table-responsive">
                                                ...
                                                <tbody>
                                                    <?php 
                                                    $allData = \Config\Database::connect()->table(' db_daily_night_watch_report')->orderBy('question', 'asc')->where('DATE(created_at)', $date)->get()->getResultArray(); 
