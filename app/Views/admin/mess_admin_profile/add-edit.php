    ...
    <div class="page-header card">
        <div class="row align-items-end">
            ...
            <div class="col-lg-4">
                ...
                <?php   $singleRecord = singleData('db_mess_admin_profile', ['userId' =>  $_SESSION['user']['id']]); ?>
                            ...
                            <div class="px-7 py-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2"> 
                                        <label class="form-label fw-semibold">Name Of Mess</label>
                                    ...
                                    <div class="col-md-6 mb-2"> 
                                        ...
                                        <label class="form-label fw-semibold">Name of Mess Agency/Manager</label>
                                        <input type="text" name="agency" class="form-control" value="<?php if (!empty($singleRecord)){ echo $singleRecord['agency'];}?>"  >
                                        <span class="text-danger" id="name"></span>
                                    </div>
                                    <div class="col-md-6 mb-2"> 

                                        <label class="form-label fw-semibold">Head Cook</label>
                                        <input type="text" name="headCook" class="form-control" value="<?php if (!empty($singleRecord)){ echo $singleRecord['headCook'];}?>"  >
                                        <span class="text-danger" id="name"></span>
                                    </div>
