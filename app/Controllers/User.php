...
class User extends BaseController
{
    ...
    public function index($param1)
    {
        if (isset($_SESSION['user']) && ($_SESSION['role'] != 1)) {
            $data['page_name']  = $param1;
            $data['page_title'] = $param1;
    ...
    public function user($param1)
    {
        if (isset($_SESSION['user']) && ($_SESSION['role'] != 1)) {
            $data['page_name']  = $param1;
            $data['page_title'] = ucwords(str_replace('_', ' ', $param1));
            // $data['table']      =  $this->curd->selectData($this->dbcode.$this->page);
            
            return view('user/common/list', $data);
        }
        return view('admin/login');
    }
    ...
    public function addEdit($param1 = '')
    {
        if (isset($_SESSION['user'])) {
            ...
            return view('user/common/add-edit', $data);
        }
